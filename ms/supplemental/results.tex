...
\centering
\subfloat[E-size estimation, estimations vs true]{%
\includegraphics[scale=0.35]{figures/rhodo_plots/x_axis=k,y_axis=e_size} 
\label{fig:staph_isize}}
\subfloat[Number of nodes in DBG, estimations vs true]{%
\includegraphics[scale=0.35]{figures/rhodo_plots/x_axis=k,y_axis=nr_nodes}
\label{fig:staph_fit}}
...
\centering
\subfloat[E-size estimation, estimations vs true]{%
\includegraphics[scale=0.35]{figures/hs14_plots/x_axis=k,y_axis=e_size} 
\label{fig:staph_isize}}
\subfloat[Number of nodes in DBG, estimations vs true]{%
\includegraphics[scale=0.35]{figures/hs14_plots/x_axis=k,y_axis=nr_nodes}
\label{fig:staph_fit}}
